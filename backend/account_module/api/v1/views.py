...
from rest_framework_simplejwt.tokens import (
    RefreshToken,
)  # this is for email sending and token generation
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            email_obj = EmailMessage(
                ...
                {"name": user_obj, "user_token": user_token},
                "admin@gmail.com",
                to=[user_email],
            )
...
class ActivationResendGenerciAPIView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response(
            {
                "detail": "user activation resend successfully;so check your email to activate your account"
            },
            status=status.HTTP_200_OK,
        )
